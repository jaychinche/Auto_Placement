...
<body>
    ...
    <div class="container col-12 m-5">
      ...
      if(isset($_POST['btn_img']))
      {
        ...
        $sql = "INSERT INTO `insertpdf`(`image`)VALUES('$filename')";
        if($filename == "")
        {
            echo 
            "
        ...
        ?>
         ...
         <form action="pdf.php" method="post" class="form-control" enctype="multipart/form-data">
        ...
        <table class="table text-center">
            ...
            $sql2 = "SELECT*FROM `insertpdf` WHERE 1";
